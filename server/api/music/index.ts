...
export default defineEventHandler((event) => {
  ...
  const musicList: IMusicApi = {
    pianino: [
      {
        id: 1,
        logo: "/img/music/chopin_square.jpg",
        name: "Cry of soul",
    ...
    koto: [
      {
        id: 1,
        logo: "/img/music/koto-yurimoto_keiko-koto-x800.jpg",
    ...
    violin: [
      {
        id: 1,
        logo: "/img/music/vivaldi-1639578130-editorial-long-form-0.jpg",
    ...
    shamisen: [
      {
        id: 1,
        logo: "/img/music/tsugaru-shamisen_2.jpg",
