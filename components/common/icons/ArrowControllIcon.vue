<template>
  <svg
    ...
    style="enable-background: new 0 0 493.52 493.52"
    xml:space="preserve"
    class="arrow-controll-icon"
    :class="classObject"
  >
    <g>
      <g>
...
interface IArrowControllIconProps {
  direction?: directionArrow;
}

const props = withDefaults<
  IArrowControllIconProps,
  Required<IArrowControllIconProps>
>(defineProps<IArrowControllIconProps>(), {
  direction: directionArrow.LEFT,
});

const classObject = computed(() => {
  return `arrow-controll-icon__${props.direction}`;
});
</script>
...
.arrow-controll-icon {
  height: 20px;
  // .arrow-controll-icon__left
  &__left {
  }

  // .arrow-controll-icon__right
  &__right {
